...
/* harmony import */ var _step_step__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/components/step/step.js");
...
class BRCarousel {
  constructor(name, component) {
    ...
    this.step = new _step_step__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A('br-step', this.DOMstrings.step)
    this._setBehavior()
  }
  ...
  _setBehavior() {
    ...
    // Swipe
    const dispatcher = new _partial_js_behavior_swipe__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A(this.DOMstrings.carouselStage)
...
/* harmony export */ });
/* harmony import */ var _partial_js_behavior_checkgroup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/partial/js/behavior/checkgroup.js");
/* harmony import */ var _cookiebar_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/components/cookiebar/cookiebar-data.js");
/* harmony import */ var _cookiebar_templates__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/components/cookiebar/cookiebar-templates.js");
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/components/cookiebar/selectors.js");
...
class BRCookiebar {
  ...
  constructor({ name, component, json, lang, mode = 'default', callback }) {
    this.name = name
    this.component = component
    this.data = new _cookiebar_data__WEBPACK_IMPORTED_MODULE_1__.CookiebarData(json, lang)
    this.templates = new _cookiebar_templates__WEBPACK_IMPORTED_MODULE_2__.CookiebarTemplates(this.data)
    this.mode = mode
  ...
  _setAcceptButtonBehavior() {
    const acceptButton = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_3__.ACCEPT_BUTTON)
  ...
  _setPoliticsButtonBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.POLITICS_BUTTON).forEach((politicsButton) => {
      // Expande o cookiebar
  ...
  _setCloseButtonBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.CLOSE_BUTTON).forEach((closeButton) => {
      ...
      closeButton.addEventListener('click', () => {
        ...
        this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_3__.POLITICS_BUTTON).classList.remove('d-none')
        document.body.style.overflowY = 'auto'
  ...
  _setWindowResizeBehavior() {
    window.addEventListener('resize', () => {
      ...
      this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.ACTION_BUTTONS).forEach((button) => {
  ...
  _setToggleGroupBehavior() {
    this.component
      .querySelectorAll(
        `${`${_selectors__WEBPACK_IMPORTED_MODULE_3__.GROUP_BUTTON}, ${_selectors__WEBPACK_IMPORTED_MODULE_3__.GROUP_NAME}, ${_selectors__WEBPACK_IMPORTED_MODULE_3__.COOKIES_CHECKED}, ${_selectors__WEBPACK_IMPORTED_MODULE_3__.GROUP_SIZE}`}`
      )
      .forEach((clickable) => {
  ...
  _handleToggleGroupClick(event) {
    ...
    if (element.classList.contains('open')) {
      ...
      element.nextElementSibling.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.BR_SWITCH).forEach((check) => {
  ...
  _setCheckboxBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.PARENT_CHECKBOX).forEach((trigger) => {
      this.checkgroupBehavior = new _partial_js_behavior_checkgroup__WEBPACK_IMPORTED_MODULE_0__["default"](trigger)
  ...
  _setSelectionBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.CHECKBOX).forEach((checkbox) => {
  ...
  _displayBroadAlertMessage() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.BROAD_ALERT).forEach((broadAlert) => {
  ...
  _displayGroupAlertMessage(groupIndex) {
    const group = this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.GROUP_INFO)[groupIndex]
    group.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.GROUP_ALERT).forEach((groupAlert) => {
      if (
  ...
  _displayCookieAlertMessage(groupIndex, cookieIndex) {
    const group = this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.GROUP_INFO)[groupIndex]
    const cookie = group.nextElementSibling.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.COOKIE_CARD)[cookieIndex]
    cookie.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.COOKIE_ALERT).forEach((cookieAlert) => {
      if (
  ...
  _toggleIcon(element, oldIcon, newIcon) {
    element.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.BUTTON_ICON).forEach((icon) => {
  ...
  _scrollUp(element) {
    setTimeout(() => {
      this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.WRAPPER).forEach(() => {
        setTimeout(() => {
  ...
  _showCookiebar() {
    ...
    switch (this.mode) {
      case 'open':
        this.component.classList.remove('default')
        this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_3__.POLITICS_BUTTON).forEach((button) => {
   ...
   */
  _setOpenView() {
    const wrapper = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_3__.WRAPPER)
    const containerFluid = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_3__.CONTAINER_FLUID)
    const modalFooter = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_3__.MODAL_FOOTER)
   ...
   */
  _setDefaultView() {
    this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_3__.WRAPPER).removeAttribute('style')
  }
...
/* harmony export */ });
/* harmony import */ var _partial_js_behavior_collapse__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/partial/js/behavior/collapse.js");
/* harmony import */ var _partial_js_behavior_dropdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/partial/js/behavior/dropdown.js");
...
class BRTable {
  ...
  _dropdownBehavior() {
    this.component.querySelectorAll('[data-toggle="dropdown"]').forEach((trigger) => {
      ...
      this.dropdown = new _partial_js_behavior_dropdown__WEBPACK_IMPORTED_MODULE_1__["default"](config)
